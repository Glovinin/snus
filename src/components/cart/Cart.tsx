                                            ...
                                            <div className="mt-auto flex items-center justify-between">
                                                ...
                                                <div className="flex items-center gap-1 bg-background rounded-full border border-foreground/10 p-1 shadow-sm">
                                                    <button
                                                        ...
                                                        className="w-7 h-7 flex items-center justify-center rounded-full hover:bg-foreground/5 transition-colors"
                                                    >
                                                ...
                                                <button
                                                    ...
                                                    className="text-muted-foreground/50 hover:text-red-500 transition-colors p-2"
                                                >
