...
## Operações de Armazém e Plano de Negócio (Portugal)

### 19.1 Infraestrutura do Armazém

**Localização do Armazém:**
- **Base**: Portugal (localização estratégica para distribuição europeia)
- **Tamanho**: Espaço otimizado para 75+ tipos de produtos de 2 marcas principais
- **Instalações**:
  - Armazenamento climatizado (para preservação de produtos)
  - Áreas de armazenamento seguras
  - Zonas de picking e packing
  - Área de controle de qualidade
  - Docas de recebimento e envio
  - Espaço de escritório para gestão do armazém
  - Sala de descanso e instalações para funcionários

**Layout do Armazém:**
- **Área de Recebimento**: Inspeção e armazenamento de produtos recebidos
- **Zonas de Armazenamento**: Organizadas por marca e categoria de produto
  - Zona de produtos da Marca 1
  - Zona de produtos da Marca 2
  - Produtos de alta rotação (fast-moving)
  - Produtos de baixa rotação (slow-moving)
- **Zonas de Picking**: Otimizadas para fulfillment eficiente de pedidos
- **Estações de Packing**: Múltiplas estações para preparação de pedidos
- **Controle de Qualidade**: Inspeção final antes do envio
- **Área de Envio**: Impressão de etiquetas, integração com transportadoras, expedição

### 19.2 Portfólio de Produtos

**Gama de Produtos:**
- **Total de Produtos**: 75+ tipos de produtos
- **Marcas**: 2 marcas principais
- **Categorias de Produtos**:
  - Produtos snus (várias resistências e sabores)
  - Nicotine pouches
  - Chewing bags
  - Acessórios e produtos relacionados
- **Gestão de SKU**: Cada tipo de produto com SKU único
- **Rastreamento de Inventário**: Sistema de gestão de inventário em tempo real

**Gestão de Inventário:**
- **Níveis de Stock**: Manter níveis ótimos de stock para todos os 75+ produtos
- **Reabastecimento**: Pontos de reordenação automatizados
- **Rotação de Stock**: Sistema FIFO (First In, First Out)
- **Rastreamento de Lotes**: Rastrear lotes e datas de validade
- **Multi-localização**: Suporte para múltiplas localizações de armazém (expansão futura)

### 19.3 Estrutura de Funcionários do Armazém

**Organograma:**

**Nível de Gestão (3-4 funcionários):**
- **Gerente de Armazém** (1): Operações gerais do armazém, gestão de funcionários, otimização de processos
- **Supervisor de Operações** (1): Operações do dia a dia, controle de qualidade, escalonamento
- **Coordenador de Inventário** (1): Gestão de stock, encomendas, coordenação com fornecedores
- **Coordenador de Logística** (1): Coordenação de envios, relações com transportadoras, documentação alfandegária

**Nível Operacional (8-12 funcionários):**

**Equipa de Recebimento (2 funcionários):**
- **Funcionário de Recebimento** (1): Receber remessas recebidas, verificar quantidades, inspecionar qualidade
- **Operador de Stock** (1): Mover produtos para localizações de armazenamento, atualizar sistema de inventário

**Equipa de Picking (3-4 funcionários):**
- **Pickers de Pedidos** (3-4): Recolher produtos de acordo com pedidos, garantir precisão
- **Supervisor de Picking** (1, parte da equipa): Supervisionar operações de picking, resolver problemas

**Equipa de Packing (2-3 funcionários):**
- **Empacotadores** (2-3): Empacotar pedidos, preparar etiquetas de envio, garantir embalagem adequada

**Controle de Qualidade (1 funcionário):**
- **Inspetor de QC** (1): Verificação final de qualidade antes do envio, verificar precisão do pedido

**Equipa de Envio (1-2 funcionários):**
- **Funcionário de Envio** (1-2): Preparar remessas, coordenar com transportadoras, lidar com documentação

**Funcionários de Apoio (1-2 funcionários):**
- **Assistente de Armazém** (1-2): Apoio geral, manutenção, limpeza, reabastecimento de materiais

**Total de Funcionários: 11-18 funcionários** (dependendo do volume de pedidos e fase de crescimento)

**Escalonamento de Funcionários:**
- **Funcionários a tempo inteiro**: Equipa principal (8-10 funcionários)
- **Funcionários a tempo parcial**: Contratação flexível para períodos de pico (3-8 funcionários)
- **Sistema de Turnos**: 
  - Turno diurno: 8:00 - 17:00 (operações principais)
  - Horário estendido: 7:00 - 19:00 (durante épocas de pico)
  - Turnos de fim de semana: Conforme necessário para fulfillment de pedidos

### 19.4 Processos Operacionais

**Processo de Recebimento:**
1. **Remessa Recebida**: Receber produtos de fornecedores/marcas
2. **Inspeção**: Verificação de qualidade e quantidade
3. **Documentação**: Atualizar sistema de inventário, registar números de lote
4. **Armazenamento**: Colocar produtos em zonas de armazenamento designadas
5. **Atualização do Sistema**: Atualização de inventário em tempo real na plataforma

**Processo de Fulfillment de Pedidos:**
1. **Recebimento do Pedido**: Pedido recebido da plataforma (automático)
2. **Picking do Pedido**: Picker recolhe produtos do armazenamento
3. **Verificação de Qualidade**: Verificar se produtos correspondem ao pedido
4. **Empacotamento**: Empacotar produtos de forma segura com materiais apropriados
5. **Geração de Etiqueta**: Gerar etiquetas de envio automaticamente
6. **Inspeção QC**: Verificação final de controle de qualidade
7. **Envio**: Entregar à transportadora, atualizar tracking
8. **Atualização do Sistema**: Marcar pedido como enviado na plataforma

**Operações Diárias:**
- **Manhã**: Recebimento de novas remessas, atualizações de inventário
- **Meio-dia**: Picking e packing de pedidos (atividade de pico)
- **Tarde**: Preparação de envios, recolhas de transportadoras
- **Final do Dia**: Reconciliação de inventário, preparação para o dia seguinte

### 19.5 Tecnologia e Sistemas

**Sistema de Gestão de Armazém (WMS):**
- **Gestão de Inventário**: Rastreamento de stock em tempo real
- **Gestão de Pedidos**: Processamento e fulfillment de pedidos
- **Digitalização de Código de Barras**: Digitalização de código de barras/RFID para precisão
- **Listas de Picking**: Listas de picking digitais para pickers
- **Integração de Envio**: Integração direta com sistemas de transportadoras
- **Relatórios**: Relatórios de operações diárias, relatórios de inventário

**Equipamento:**
- **Leitores de Código de Barras**: Para rastreamento de inventário e pedidos
- **Impressoras de Etiquetas**: Impressão de etiquetas de envio
- **Computadores/Tablets**: Para acesso ao WMS nas estações de trabalho
- **Equipamento de Embalagem**: Balanças, dispensadores de fita, materiais de embalagem
- **Manuseamento de Materiais**: Carrinhos de mão, paleteiras (se necessário)
- **Sistemas de Segurança**: CCTV, controle de acesso

### 19.6 Plano de Negócio e Projeções Financeiras

**Modelo de Negócio:**
- **Fluxos de Receita**:
  - Vendas de produtos (B2C e B2B)
  - Comissões da plataforma (se modelo marketplace)
  - Receita de publicidade de marcas (banners na hero section)
  - Taxas de subscrição/adesão
- **Estrutura de Custos**:
  - Aluguer e utilidades do armazém
  - Salários e benefícios dos funcionários
  - Custos de inventário (75+ produtos de 2 marcas)
  - Custos de envio e logística
  - Custos de tecnologia e software
  - Custos de marketing e publicidade

**Investimento Inicial (Fase MVP):**
- **Configuração do Armazém**: €15.000 - €25.000
  - Inventário inicial (75+ produtos, 2 marcas)
  - Equipamento e sistemas do armazém
  - Materiais de embalagem iniciais
- **Tecnologia**: €5.000 - €10.000
  - Configuração do sistema WMS
  - Hardware (leitores, impressoras, computadores)
  - Desenvolvimento da plataforma
- **Capital de Funcionamento**: €20.000 - €40.000
  - Despesas operacionais dos primeiros 3 meses
...
**Custos Fixos:**
- **Aluguer do Armazém**: €2.000 - €4.000/mês (dependendo do tamanho e localização)
- **Utilidades**: €300 - €500/mês
- **Seguro**: €200 - €400/mês
- **Tecnologia/Software**: €500 - €1.000/mês
- **Total Fixo**: €3.000 - €5.900/mês

**Custos Variáveis:**
- **Salários dos Funcionários**: €15.000 - €25.000/mês (11-18 funcionários)
  - Gestão: €4.000 - €6.000/mês
  - Funcionários operacionais: €11.000 - €19.000/mês
- **Inventário**: Variável com base no volume de vendas
- **Custos de Envio**: Variável com base nos pedidos
- **Materiais de Embalagem**: €500 - €1.500/mês
- **Marketing**: €2.000 - €5.000/mês

**Total de Custos Mensais**: €20.500 - €37.400/mês (excluindo inventário e envio)

**Projeções de Receita:**

**Fase MVP (Meses 1-3):**
- **Pedidos Alvo**: 500-1.000 pedidos/mês
- **Valor Médio do Pedido**: €50-€80
- **Receita Mensal**: €25.000 - €80.000
- **Break-even**: Mês 2-3

**Fase de Crescimento (Meses 4-6):**
- **Pedidos Alvo**: 1.500-3.000 pedidos/mês
- **Valor Médio do Pedido**: €60-€90
- **Receita Mensal**: €90.000 - €270.000
- **Rentabilidade**: Margens positivas

**Fase de Escala (Meses 7-12):**
- **Pedidos Alvo**: 5.000-10.000 pedidos/mês
- **Valor Médio do Pedido**: €70-€100
- **Receita Mensal**: €350.000 - €1.000.000
- **Expansão**: Localizações adicionais de armazém, aumento de funcionários

### 19.7 Requisitos de Funcionários por Volume de Vendas

**Métricas de Produtividade:**
- **Pedidos Médios por Picker por Dia**: 50-80 pedidos (dependendo da complexidade)
- **Pedidos Médios por Packer por Dia**: 60-100 pedidos
- **Dias Úteis por Mês**: 22 dias (média)
- **Horas de Trabalho por Dia**: 8 horas
- **Multiplicador de Época de Pico**: 1.5x (requer funcionários temporários adicionais)

**Fórmula de Cálculo de Funcionários:**
- **Pickers Necessários** = (Pedidos Mensais ÷ Pedidos por Picker por Dia) ÷ Dias Úteis por Mês
- **Packers Necessários** = (Pedidos Mensais ÷ Pedidos por Packer por Dia) ÷ Dias Úteis por Mês
- **Funcionários de Gestão**: Proporção fixa (1 gestor por 5-7 funcionários operacionais)
- **Funcionários de Apoio**: Proporção fixa (1 apoio por 8-10 funcionários operacionais)

**Requisitos Detalhados de Funcionários por Volume:**

#### Nível de Volume 1: 0-500 Pedidos/Mês
- **Total de Funcionários**: 8-10 funcionários
- **Gestão**: 2 funcionários (Gerente de Armazém, Supervisor de Operações)
- **Recebimento**: 1 funcionário (a tempo parcial ou partilhado)
- **Picking**: 1-2 funcionários (podem lidar com 50-100 pedidos/dia)
- **Packing**: 1 funcionário (pode lidar com 60-100 pedidos/dia)
- **QC**: 0.5 funcionário (partilhado com packing)
- **Envio**: 1 funcionário (a tempo parcial)
- **Apoio**: 1 funcionário (a tempo parcial)
- **Cálculo**: 500 pedidos ÷ 22 dias = 23 pedidos/dia → 1 picker + 1 packer suficientes

#### Nível de Volume 2: 501-1.000 Pedidos/Mês
- **Total de Funcionários**: 11-13 funcionários
- **Gestão**: 3 funcionários (Gerente de Armazém, Supervisor de Operações, Coordenador de Inventário)
- **Recebimento**: 1 funcionário
- **Picking**: 2 funcionários (podem lidar com 100-160 pedidos/dia)
- **Packing**: 2 funcionários (podem lidar com 120-200 pedidos/dia)
- **QC**: 1 funcionário
- **Envio**: 1 funcionário
- **Apoio**: 1 funcionário
- **Cálculo**: 1.000 pedidos ÷ 22 dias = 45 pedidos/dia → 2 pickers + 2 packers necessários

#### Nível de Volume 3: 1.001-2.000 Pedidos/Mês
- **Total de Funcionários**: 14-16 funcionários
- **Gestão**: 3 funcionários (adicionar Coordenador de Logística se necessário)
- **Recebimento**: 2 funcionários
- **Picking**: 3 funcionários (podem lidar com 150-240 pedidos/dia)
- **Packing**: 3 funcionários (podem lidar com 180-300 pedidos/dia)
- **QC**: 1 funcionário
- **Envio**: 1-2 funcionários
- **Apoio**: 1 funcionário
- **Cálculo**: 2.000 pedidos ÷ 22 dias = 91 pedidos/dia → 3 pickers + 3 packers necessários

#### Nível de Volume 4: 2.001-3.500 Pedidos/Mês
- **Total de Funcionários**: 16-18 funcionários
- **Gestão**: 4 funcionários (equipa de gestão completa)
- **Recebimento**: 2 funcionários
- **Picking**: 4 funcionários (podem lidar com 200-320 pedidos/dia)
- **Packing**: 4 funcionários (podem lidar com 240-400 pedidos/dia)
- **QC**: 1 funcionário
- **Envio**: 2 funcionários
- **Apoio**: 1-2 funcionários
- **Cálculo**: 3.500 pedidos ÷ 22 dias = 159 pedidos/dia → 4 pickers + 4 packers necessários

#### Nível de Volume 5: 3.501-5.000 Pedidos/Mês
- **Total de Funcionários**: 18-22 funcionários
- **Gestão**: 4 funcionários
- **Recebimento**: 2 funcionários
- **Picking**: 5-6 funcionários (podem lidar com 250-480 pedidos/dia)
- **Packing**: 5-6 funcionários (podem lidar com 300-600 pedidos/dia)
- **QC**: 1-2 funcionários
- **Envio**: 2 funcionários
- **Apoio**: 2 funcionários
- **Cálculo**: 5.000 pedidos ÷ 22 dias = 227 pedidos/dia → 5-6 pickers + 5-6 packers necessários

#### Nível de Volume 6: 5.001-7.500 Pedidos/Mês
- **Total de Funcionários**: 22-26 funcionários
- **Gestão**: 4-5 funcionários
- **Recebimento**: 2-3 funcionários
- **Picking**: 7-8 funcionários (podem lidar com 350-640 pedidos/dia)
- **Packing**: 7-8 funcionários (podem lidar com 420-800 pedidos/dia)
- **QC**: 2 funcionários
- **Envio**: 2-3 funcionários
- **Apoio**: 2 funcionários
- **Cálculo**: 7.500 pedidos ÷ 22 dias = 341 pedidos/dia → 7-8 pickers + 7-8 packers necessários

#### Nível de Volume 7: 7.501-10.000 Pedidos/Mês
- **Total de Funcionários**: 26-30 funcionários
- **Gestão**: 5 funcionários
- **Recebimento**: 3 funcionários
- **Picking**: 9-10 funcionários (podem lidar com 450-800 pedidos/dia)
- **Packing**: 9-10 funcionários (podem lidar com 540-1.000 pedidos/dia)
- **QC**: 2 funcionários
- **Envio**: 3 funcionários
- **Apoio**: 2-3 funcionários
- **Cálculo**: 10.000 pedidos ÷ 22 dias = 455 pedidos/dia → 9-10 pickers + 9-10 packers necessários

#### Nível de Volume 8: 10.001-15.000 Pedidos/Mês
- **Total de Funcionários**: 30-38 funcionários
- **Gestão**: 5-6 funcionários
- **Recebimento**: 3-4 funcionários
- **Picking**: 12-15 funcionários (podem lidar com 600-1.200 pedidos/dia)
- **Packing**: 12-15 funcionários (podem lidar com 720-1.500 pedidos/dia)
- **QC**: 3 funcionários
- **Envio**: 4 funcionários
- **Apoio**: 3-4 funcionários
- **Cálculo**: 15.000 pedidos ÷ 22 dias = 682 pedidos/dia → 12-15 pickers + 12-15 packers necessários
- **Nota**: Considerar segundo turno ou automação neste volume

#### Nível de Volume 9: 15.001-20.000 Pedidos/Mês
- **Total de Funcionários**: 38-45 funcionários
- **Gestão**: 6 funcionários
- **Recebimento**: 4 funcionários
- **Picking**: 16-20 funcionários (podem lidar com 800-1.600 pedidos/dia)
- **Packing**: 16-20 funcionários (podem lidar com 960-2.000 pedidos/dia)
- **QC**: 3-4 funcionários
- **Envio**: 5 funcionários
- **Apoio**: 4-5 funcionários
- **Cálculo**: 20.000 pedidos ÷ 22 dias = 909 pedidos/dia → 16-20 pickers + 16-20 packers necessários
- **Nota**: Segundo turno recomendado, automação altamente recomendada

#### Nível de Volume 10: 20.001+ Pedidos/Mês
- **Total de Funcionários**: 45+ funcionários (ou múltiplos armazéns)
- **Gestão**: 6+ funcionários por localização
- **Múltiplos Turnos**: Turno diurno + turno noturno
- **Automação**: Necessária (sistemas de correia transportadora, picking automatizado)
- **Múltiplos Armazéns**: Considerar centros de distribuição regionais
- **Cálculo**: Requer gestão avançada de armazém e sistemas de automação

**Ajustes para Época de Pico:**
- **Black Friday / Natal**: Adicionar 50% de funcionários temporários
- **Exemplo**: Se volume normal requer 20 funcionários, época de pico precisa de 30 funcionários
- **Funcionários Temporários**: Contratar trabalhadores sazonais ou usar agências de recrutamento
- **Horas Extras**: Autorizar horas extras para funcionários existentes (até 20% de aumento)

**Melhorias de Eficiência:**
- **Otimização WMS**: Pode aumentar produtividade em 15-25%
- **Digitalização de Código de Barras**: Reduz erros e aumenta velocidade em 10-15%
- **Picking por Zona**: Pode aumentar produtividade do picker em 20-30%
- **Picking em Lote**: Pode lidar com múltiplos pedidos simultaneamente (aumento de 30-40%)
- **Automação**: Pode reduzir necessidades de funcionários em 30-50% em volumes altos

**Tabela Resumo:**

| Pedidos Mensais | Total Funcionários | Pickers | Packers | Gestão | Apoio | Tamanho Armazém |
|-----------------|-------------------|---------|---------|--------|-------|-----------------|
| 0-500 | 8-10 | 1-2 | 1 | 2 | 1 | 200-300 m² |
| 501-1.000 | 11-13 | 2 | 2 | 3 | 1 | 300-400 m² |
| 1.001-2.000 | 14-16 | 3 | 3 | 3 | 1 | 400-500 m² |
| 2.001-3.500 | 16-18 | 4 | 4 | 4 | 1-2 | 500-600 m² |
| 3.501-5.000 | 18-22 | 5-6 | 5-6 | 4 | 2 | 600-700 m² |
| 5.001-7.500 | 22-26 | 7-8 | 7-8 | 4-5 | 2 | 700-800 m² |
| 7.501-10.000 | 26-30 | 9-10 | 9-10 | 5 | 2-3 | 800-1.000 m² |
| 10.001-15.000 | 30-38 | 12-15 | 12-15 | 5-6 | 3-4 | 1.000-1.500 m² |
| 15.001-20.000 | 38-45 | 16-20 | 16-20 | 6 | 4-5 | 1.500-2.000 m² |
| 20.001+ | 45+ | 20+ | 20+ | 6+ | 5+ | 2.000+ m² ou múltiplas localizações |

**Mapeamento de Fases de Crescimento:**

**Fase 1 - Lançamento MVP (Meses 1-3):**
- **Volume Alvo**: 500-1.000 pedidos/mês
- **Total de Funcionários**: 11-13 funcionários
- **Tamanho do Armazém**: 300-400 m²

**Fase 2 - Crescimento (Meses 4-6):**
- **Volume Alvo**: 1.500-3.500 pedidos/mês
- **Total de Funcionários**: 14-18 funcionários
- **Tamanho do Armazém**: 500-600 m²

**Fase 3 - Escala (Meses 7-12):**
- **Volume Alvo**: 5.000-10.000 pedidos/mês
- **Total de Funcionários**: 22-30 funcionários
- **Tamanho do Armazém**: 800-1.000 m²

**Fase 4 - Expansão (Ano 2+):**
- **Volume Alvo**: 15.000+ pedidos/mês
- **Total de Funcionários**: 38-45+ funcionários (ou múltiplos armazéns)
- **Tamanho do Armazém**: 1.500+ m² ou múltiplas localizações
- **Automação**: Introdução de sistemas de automação

### 19.8 Controle de Qualidade e Conformidade

**Padrões de Qualidade:**
- **Inspeção de Produtos**: Todos os produtos recebidos inspecionados
- **Precisão de Pedidos**: Meta de precisão de 99.5%+
- **Qualidade de Embalagem**: Embalagem segura e profissional
- **Gestão de Data de Validade**: Sistema FIFO, nenhum produto expirado enviado
- **Documentação**: Rastreabilidade completa de todos os produtos

**Conformidade:**
- **Conformidade TPD**: Todos os produtos em conformidade com a Diretiva de Produtos de Tabaco
- **Requisitos de Armazenamento**: Condições de armazenamento adequadas mantidas
- **Documentação**: Registos completos para conformidade regulatória
- **Saúde e Segurança**: Padrões de segurança no local de trabalho (regulamentos portugueses)
- **Ambiental**: Gestão adequada de resíduos e reciclagem

### 19.9 Escalabilidade e Plano de Expansão

**Curto Prazo (6 meses):**
- Otimizar operações atuais do armazém
- Aumentar capacidade de processamento de pedidos
- Melhorar eficiência através de otimização de processos
- Expandir gama de produtos se necessário

**Médio Prazo (12 meses):**
- Considerar segunda localização de armazém (se necessário)
- Implementar automação onde benéfico
- Expandir para mercados europeus adicionais
- Aumentar portfólio de produtos

**Longo Prazo (2+ anos):**
- Múltiplas localizações de armazém em toda a Europa
- Automação avançada e robótica
- Centros de distribuição regionais
- Parceria com fornecedores 3PL para regiões específicas

### 19.10 Indicadores-Chave de Desempenho (KPIs)

**KPIs Operacionais:**
- **Tempo de Fulfillment de Pedidos**: Meta < 24 horas do pedido ao envio
- **Precisão de Pedidos**: Meta 99.5%+
- **Precisão de Inventário**: Meta 99%+
- **Produtividade de Picking**: Pedidos recolhidos por hora por funcionário
- **Envio Pontual**: Meta 98%+

**KPIs Financeiros:**
- **Receita por Funcionário**: Medida de produtividade
- **Custo por Pedido**: Custo total de fulfillment por pedido
- **Rotatividade de Inventário**: Rapidez com que o inventário é vendido
- **Margens de Lucro**: Margens de lucro bruto e líquido

**KPIs de Satisfação do Cliente:**
- **Tempo de Entrega do Pedido**: Tempo médio do pedido à entrega
- **Remessas Danificadas**: Meta < 0.5%
- **Reclamações de Clientes**: Meta < 1% dos pedidos
- **Taxa de Devolução**: Monitorizar e minimizar devoluções
